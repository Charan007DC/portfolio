...
export default function PremiumNavbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'about', 'focus', 'experience', 'projects', 'skills', 'achievements', 'contact'];
        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <a
              href="/resume.pdf"
              download
              className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-accent hover:bg-accent/90 text-white text-sm font-medium transition-all hover:shadow-lg hover:shadow-accent/50"
            >
              <FileText size={18} />
              <span>Resume</span>
            </a>
